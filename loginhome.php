...
<body>
	...
	<!-- Chill Music Background For The Website-->
	<audio autoplay>
		<source src="music/bg.mp3" type="audio/mpe/">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navmenu">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item">
						<a href="shipping_two.html" class="nav-link">Shipping</a>
					</li>
					<li class="nav-item">
...
<!-- 			<center><h1>test</h1></center> -->
				<center><h1 class="d-sm-flex justify-content-center redgrad" style="text-align; color:#90EE90;"><u>Types of Shipping Services</u></h1></center>
			<hr>
			<br>
			<br>
			<br>
	  	 	...
	  	 	<div class="row">
	  	 		<div class="footer-col">
	  	 			...
	  	 			<ul>
	  	 				...
	  	 				<li><a href="shipping_two.html">Purchase Shipping Order</a></li> 
...
<!-- 	<iframe width="560" height="315" src="https://www.youtube.com/embed/H8vh29F1Ozs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->
	...
	<script>
		...
		//youtube miniplayer being played while scrolling
